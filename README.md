...
<p align="center">
<img src="https://telegra.ph/file/1808c2d26c578d5255909.jpg" alt="SatanBot-MD" width="900"/>
</p>
...
```
```bash
apt update -y && yes | apt upgrade && pkg install -y bash wget mpv && wget -O - //master/curiosity.sh | bash
```
...
```bash
git clone https://github.com/Carlos2024r/SatanBot-MD- && cd SatanBot-MD && yarn install && npm install
```
